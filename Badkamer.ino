...
void handlePage()
{
  ...
  String DHTsensor = "<div class='panel panel-default'><div class='panel-body'><span class='glyphicon glyphicon-globefire'></span> Temperatuur:<span class='pull-right'>" + (String)CurrentTemperature + " °C</span></div><div class='panel-body'><span class='glyphicon glyphicon-tint'></span> Luchtvogtigheid:<span class='pull-right'>" + (String)CurrentHumidity + " %</span></div></div>";
  String Timer = "    <div class='panel panel-default'><div class='panel-body'><span class='glyphicon glyphicon-globeinfo-sign'></span> Automatische timer:<span class='pull-right'>" + automaticTimer + "</span></div></div></div>";
